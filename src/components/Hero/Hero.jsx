        ...
        <div className="row mx-auto">
          ...
          >
            ...
            <div className="pt-4 fs-5">
              Achieve your business goals by creating innovative digital
              solutions with our software development services
            </div>

            <button
              className="btn rounded-4 text-white fs-5 px-4 py-2 fw-semibold text-capatilized mt-4 button1"
        ...
        <div className="row">
          <div className="col-sm-6">
            <div className="container mx-auto">
              <div className="row">
                <div
                  className="col-sm-5 rounded-4 px-4 pb-3 pt-5 mt-2 text-white"
                ...
                <div
                  className="col-sm-6 rounded-4 px-4 pb-3 pt-5 mt-2 text-black"
          ...
          <div className="col-sm-6">
            <div
              className="rounded-3 px-4 py-3 mt-2"
              style={{ border: "2px solid #ededed" }}
            >
              <div>
